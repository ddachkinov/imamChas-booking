...
export const calendarApi = {
  ...
  async getCalendarData(params: {
    ...
    const response = await apiClient.get<CalendarData>(`/calendar/view?${queryParams.toString()}`);
    return response;
  },
  ...
  async getAppointment(appointmentId: string): Promise<CalendarAppointment> {
    return await apiClient.get<CalendarAppointment>(`/appointments/${appointmentId}`);
  },
  ...
  async createAppointment(data: AppointmentFormData): Promise<CalendarAppointment> {
    return await apiClient.post<CalendarAppointment>('/appointments', data);
  },
  ...
  async quickCreateAppointment(data: QuickCreateFormData): Promise<CalendarAppointment> {
    ...
    return await apiClient.post<CalendarAppointment>('/appointments', formData);
  },
  ...
  async updateAppointment(
    ...
    return await apiClient.put<CalendarAppointment>(`/appointments/${appointmentId}`, data);
  },
  ...
  async rescheduleAppointment(request: RescheduleRequest): Promise<CalendarAppointment> {
    return await apiClient.put<CalendarAppointment>(
  ...
  async cancelAppointment(
    ...
    return await apiClient.put<CalendarAppointment>(`/appointments/${appointmentId}/cancel`, {
      reason,
  ...
  async checkConflicts(params: {
    ...
    return await apiClient.get<AppointmentConflict>(
  ...
  async searchAppointments(params: {
    ...
    return await apiClient.get<CalendarAppointment[]>(
  ...
  async getBlockedTimes(params: {
    ...
    return await apiClient.get<BlockedTime[]>(`/blocked-time?${queryParams.toString()}`);
  },
  ...
  async createBlockedTime(data: BlockedTimeFormData): Promise<BlockedTime> {
    return await apiClient.post<BlockedTime>('/blocked-time', data);
  },
  ...
  async updateBlockedTime(blockId: string, data: Partial<BlockedTimeFormData>): Promise<BlockedTime> {
    return await apiClient.put<BlockedTime>(`/blocked-time/${blockId}`, data);
  },
  ...
  async deleteBlockedTime(blockId: string): Promise<void> {
    await apiClient.delete(`/blocked-time/${blockId}`);
  },
  ...
  async approveTimeOff(blockId: string): Promise<BlockedTime> {
    return await apiClient.put<BlockedTime>(`/blocked-time/${blockId}/approve`, {});
  },
  ...
  async rejectTimeOff(blockId: string, reason?: string): Promise<BlockedTime> {
    return await apiClient.put<BlockedTime>(`/blocked-time/${blockId}/reject`, { reason });
  },
  ...
  async searchClients(params: {
    ...
    return await apiClient.get<ClientSearchResult[]>(`/clients/search?${queryParams.toString()}`);
  },
  ...
  async getServices(params: {
    ...
    return await apiClient.get<ServiceOption[]>(`/services?${queryParams.toString()}`);
  },
  ...
  async getStaff(params: {
    ...
    return await apiClient.get<StaffOption[]>(`/staff?${queryParams.toString()}`);
  },
  ...
  async getCalendarMetrics(params: {
    ...
    return await apiClient.get<CalendarMetrics>(`/calendar/metrics?${queryParams.toString()}`);
  },
  ...
  async bulkUpdateStatus(params: {
    ...
    return await apiClient.post<{ updated: number }>('/appointments/bulk-update-status', params);
  },
};
